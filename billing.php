...
<nav  class="navbar navbar-expand-lg navbar-light bg-light  aaa">
<a class="navbar-brand" href="admin-login.php"><img src="agh.jpeg" width="100px" alt=""></a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    ...
    <!-- we are creating a bootstrap form to get the data from the user-->

    <form class="jan" >
  <div c class="form-row">
    <div class="form-group col-md-6">
      <label for="inputEmail4">Billing ID</label>
      <input type="text" name="id" class="form-control" id="id" placeholder="Billing ID">
    </div>
    <div class="form-group col-md-6">
